RSpec.describe 'max and min by pattern' do
  ...
  it 'test 5' do
    ...
    arr = stats.map { |v| v.to_s.split(".").last.size }
    print arr
    index = arr.each_with_index.max[1]
    most_digits = stats[index]
  ...
  it 'test 8' do
    ...
    max = ages.max
    oldest = { name: max[0].to_s, age: max[1]}
