RSpec.describe 'all pattern' do
  ...
  it 'test 6' do
    ...
    all_busy = friend_status.values.all?(:busy)
  ...
  it 'test 7' do
    ...
    all_five_digits = zip_codes.all? { |v| v.to_s.length == 5 }
  ...
  it 'test 8' do
    ...
    all_five_digits = zip_codes.values.all? { |v| v.to_s.length == 5}
  ...
  it 'test 9' do
    ...
    all_caps = snacks.all? { |v| v == v.upcase }
  ...
  it 'test 10' do
    ...
    all_caps = snacks.values.all? { |v| v == v.upcase }
